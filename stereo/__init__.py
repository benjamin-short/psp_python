...
def secchi(trange=['2013-11-5', '2013-11-6'],
        probe='a',
        datatype='1min',
        chn='171',
        level='l2',
    ...
    """
    Download jpg of SECCHI Image data.
    """
    
    return load(instrument='secchi'+chn, trange=trange, probe=probe, level=level, datatype=datatype, suffix=suffix, get_support_data=get_support_data, varformat=varformat, varnames=varnames, downloadonly=True, notplot=notplot, time_clip=time_clip, no_update=no_update)
