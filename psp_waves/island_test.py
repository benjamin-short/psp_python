...
t0 = '2020-06-12/00:20:00'
tf = '2020-06-12/00:40:00'
...
array = np.where(acspec_arr <= 8,np.nan,acspec_arr)
array = np.where(array > 8,1,array)  
...
islspec = axs3.pcolormesh(acspec_time,acspec_freq,acspec_arr,cmap='nipy_spectral',shading='nearest')
